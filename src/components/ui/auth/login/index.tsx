...
const LoginComponent = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-800 p-4">
      <div className="relative w-full max-w-96 py-8 px-6 rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <AnimatedContainer className="pt-6">
            <Button
              type="submit"
              className="w-full   bg-gradient-to-r from-white/10 to-white/5 hover:from-white/15 hover:to-white/10 border border-white/15 text-white font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-white/5"
            >
              Sign In
            </Button>
          </AnimatedContainer>
        ...
        <AnimatedContainer className="mt-8 pt-5 border-t border-white/10 text-center">
          <a className="text-xs text-white/60 hover:text-white transition-all">
            Forgot password?
          </a>
        </AnimatedContainer>
      </div>
